...
/*
    ...
    2. onReceiver() 메소드를 오버라이딩해서 방송 수신이 되었을 때 원하는 작업을 한다.
    3. AndroidMainfest.xml 문서에 등록을 해야 동작한다.
...
public class AirModeReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        //Intent 객체는 이 방송수신자 객체가 활성화 될 때 전달된 Intent 객체이다.
        Toast.makeText(context, "방송 수신 완료", Toast.LENGTH_SHORT).show();
        Log.e("AirModeReceiver", "방송 수신 완료");

        //비행기모드의 on/off 여부
        boolean isActivated = intent.getBooleanExtra("state", false);
        Log.e("AirModeReceiver", "활성화 여부: " + isActivated);
    }
}