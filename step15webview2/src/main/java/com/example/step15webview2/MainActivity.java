...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.setWebViewClient(new WebViewClient(){
            //override 하고 싶은 메소드가 있으면 여기서 한다.
        });
        /*
            WebView가 로딩한 웹페이지에 <input tupe = "file" /> 이런 내용이 있다면
            해당 input 요소를 클릭하면 파일을 선택할 수 있게 해야한다.
            그렇게 하기 위해서는 AndroidManifest.xml 문서에 외부 저장 장치를 사용하겠다는 permission이 있어야 한다.
            android에서 외부 저장장치는 sd card라고 부르기도 한다.
            sd card는 따로 install 하지 않아도 기본으로 장착되어 있다.

            아래의 WebChromeClient 객체를 설정해야 한다.
         */
        ...
        webView.loadUrl("http://192.168.0.29:9000/boot07");
