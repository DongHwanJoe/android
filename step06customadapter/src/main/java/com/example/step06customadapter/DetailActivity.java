...
public class DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Detail 액티비티에 전달된 인텐트 객체의 참조값 얻어오기(MainActivity에서 생성한)
        Intent intent = getIntent();
        // 인텐트 객체에 dto 라는 키값으로 담긴 데이터를 얻어와서 원래 type으로 casting 한다.
        CountryDto dto = (CountryDto)intent.getSerializableExtra("dto");
        // activity_detail.xml을 전개했을때 생성되는 UI의 참조값 얻어오가ㅣ
