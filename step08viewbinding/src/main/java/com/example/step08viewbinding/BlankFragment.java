...
public class BlankFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // view binding을 이용하려면 아래와 같이 코딩한다.

        // fragment_blank.xml 문서 => FragmentBlankBinding 클래스
        binding = FragmentBlankBinding.inflate(inflater, container, false);
        View view = binding.getRoot();

        //fragment_blank.xml 문서에 myTextView 라는 아이디를 가지고 있는 TextView의 참조값이 필요하다면.
        TextView a = binding.myTextView;

        return view;
    }

    //fragment가 layout으로 가지고있는 뷰가 파괴될 때 호출되는 메소드
    ...
    public void onDestroyView() {
        ...
        binding = null;
        //fragment 보다 View가 오래 살아남기 때문에 fragment는 사용되지 않는데
        //view만 메모리에 남아있는것을 방지하는 효과
    }
}