...
public class MainActivity extends AppCompatActivity {
    ...
    public void makeManualCancelNoti(){
        ...
        //액티비티를 실행하는데 새로운 테스크에서 실행되도록 한다( 기존에 onStop()에 머물러 있다면 제거하고 새로 시작)
        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK|Intent.FLAG_ACTIVITY_CLEAR_TASK);
        //인텐트에 msg라는 키값으로 String type을 담는다. 새로 시작된 액티비티에서 읽어낼 수 있다.
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this, CHANNEL_NAME)
                ...
                .setContentTitle("알림을 취소 해주세요") //알림의 제목
                ...
                .setAutoCancel(true); //자동 취소 되는 알람인지 여부
